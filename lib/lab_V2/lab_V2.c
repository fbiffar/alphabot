...
void Lab_V2__controller_reset(Lab_V2__controller_mem* self) {
  self->v_131 = false;
  self->v_98 = Lab_V2__St_OnLine;
  self->v_93 = true;
  self->v_87 = false;
  self->v_68 = Lab_V2__St_1_CheckState;
  self->pnr_2 = false;
  self->ck = Lab_V2__St_2_LineFollow;
  self->v_110 = true;
  self->v_105 = true;
  self->v_81 = true;
}

void Lab_V2__controller_step(float l2, float l1, float m, float r1, float r2,
                             ...
                             float stop_threshold, float move_away_right,
                             ...
                             Lab_V2__controller_mem* self) {
  
  int v_32;
  int r_4_St_2_TurnRightEnd;
  Lab_V2__st_2 s_2_St_2_TurnRightEnd;
  int r_4_St_2_WallFollowing;
  Lab_V2__st_2 s_2_St_2_WallFollowing;
  int r_4_St_2_ObstacleFollowing;
  Lab_V2__st_2 s_2_St_2_ObstacleFollowing;
  int r_4_St_2_LineFollow;
  Lab_V2__st_2 s_2_St_2_LineFollow;
  float v_34;
  float v_33;
  int v_67;
  Lab_V2__st_1 v_66;
  ...
  Lab_V2__st_1 s_1_St_1_MoveForward;
  int r_3_St_1_LeftTurnSlow;
  Lab_V2__st_1 s_1_St_1_LeftTurnSlow;
  int r_3_St_1_RightTurnSlow;
  Lab_V2__st_1 s_1_St_1_RightTurnSlow;
  int r_3_St_1_LeftTurn;
  Lab_V2__st_1 s_1_St_1_LeftTurn;
  int r_3_St_1_RightTurn;
  Lab_V2__st_1 s_1_St_1_RightTurn;
  int r_3_St_1_MoveCloser;
  Lab_V2__st_1 s_1_St_1_MoveCloser;
  int r_3_St_1_MoveAway;
  Lab_V2__st_1 s_1_St_1_MoveAway;
  int r_3_St_1_Turn90Right;
  Lab_V2__st_1 s_1_St_1_Turn90Right;
  int r_3_St_1_CheckState;
  Lab_V2__st_1 s_1_St_1_CheckState;
  Lab_V2__st_1 ck_4;
  float v_70;
  float v_69;
  float v_72;
  ...
  Lab_V2__st_1 ns_1_St_1_MoveForward;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_MoveForward;
  ...
  Lab_V2__st_1 ns_1_St_1_LeftTurnSlow;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_LeftTurnSlow;
  ...
  Lab_V2__st_1 ns_1_St_1_RightTurnSlow;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_RightTurnSlow;
  ...
  Lab_V2__st_1 ns_1_St_1_LeftTurn;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_LeftTurn;
  ...
  Lab_V2__st_1 ns_1_St_1_RightTurn;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_RightTurn;
  ...
  Lab_V2__st_1 ns_1_St_1_MoveCloser;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_MoveCloser;
  ...
  Lab_V2__st_1 ns_1_St_1_MoveAway;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_MoveAway;
  ...
  Lab_V2__st_1 ns_1_St_1_Turn90Right;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_Turn90Right;
  ...
  Lab_V2__st_1 ns_1_St_1_CheckState;
  Lab_V2__stateName st_St_2_WallFollowing_St_1_CheckState;
  ...
  int v_97;
  int r_2_St_LostLine;
  Lab_V2__st s_St_LostLine;
  int r_2_St_OnLine;
  Lab_V2__st s_St_OnLine;
  Lab_V2__st ck_2;
  float v_102;
  float v_101;
  float v_100;
  ...
  float correction;
  int nr_St_LostLine;
  Lab_V2__st ns_St_LostLine;
  Lab_V2__stateName st_St_2_LineFollow_St_LostLine;
  ...
  int nr_St_OnLine;
  Lab_V2__st ns_St_OnLine;
  Lab_V2__stateName st_St_2_LineFollow_St_OnLine;
  ...
  Lab_V2__st_2 ns_2_St_2_TurnRightEnd;
  Lab_V2__stateName st_St_2_TurnRightEnd;
  ...
  Lab_V2__st_2 ns_2_St_2_WallFollowing;
  Lab_V2__stateName st_St_2_WallFollowing;
  ...
  Lab_V2__st_2 ns_2_St_2_ObstacleFollowing;
  Lab_V2__stateName st_St_2_ObstacleFollowing;
  ...
  Lab_V2__st_2 ns_2_St_2_LineFollow;
  Lab_V2__stateName st_St_2_LineFollow;
  ...
  switch (self->ck) {
    case Lab_V2__St_2_LineFollow:
      ...
      if (v_32) {
        ...
        s_2_St_2_LineFollow = Lab_V2__St_2_ObstacleFollowing;
      } else {
        r_4_St_2_LineFollow = self->pnr_2;
        s_2_St_2_LineFollow = Lab_V2__St_2_LineFollow;
      };
    ...
    case Lab_V2__St_2_ObstacleFollowing:
      ...
      s_2_St_2_ObstacleFollowing = Lab_V2__St_2_ObstacleFollowing;
    ...
    case Lab_V2__St_2_WallFollowing:
      ...
      s_2_St_2_WallFollowing = Lab_V2__St_2_WallFollowing;
    ...
    case Lab_V2__St_2_TurnRightEnd:
      if (alligned) {
        ...
        s_2_St_2_TurnRightEnd = Lab_V2__St_2_LineFollow;
      } else {
        r_4_St_2_TurnRightEnd = self->pnr_2;
        s_2_St_2_TurnRightEnd = Lab_V2__St_2_TurnRightEnd;
      };
  ...
  switch (ck_1) {
    case Lab_V2__St_2_LineFollow:
      if (r_4) {
        pnr = false;
        ck_2 = Lab_V2__St_OnLine;
      } else {
        pnr = self->v_131;
        ck_2 = self->v_98;
      };
      nr_2_St_2_LineFollow = false;
      ns_2_St_2_LineFollow = Lab_V2__St_2_LineFollow;
      ...
      switch (ck_2) {
        case Lab_V2__St_OnLine:
          if (left_line) {
            r_2_St_OnLine = true;
            s_St_OnLine = Lab_V2__St_LostLine;
          } else {
            r_2_St_OnLine = pnr;
            s_St_OnLine = Lab_V2__St_OnLine;
          };
          s = s_St_OnLine;
          r_2 = r_2_St_OnLine;
          break;
        case Lab_V2__St_LostLine:
          ...
          if (v_97) {
            ...
            s_St_LostLine = Lab_V2__St_OnLine;
          } else {
            r_2_St_LostLine = pnr;
            s_St_LostLine = Lab_V2__St_LostLine;
          };
          s = s_St_LostLine;
          r_2 = r_2_St_LostLine;
          break;
      ...
      switch (ck_3) {
        case Lab_V2__St_OnLine:
          ...
          st_St_2_LineFollow_St_OnLine = Lab_V2__OnLine;
          v_111 = (r_4||r_2);
          if (self->v_110) {
            v_112 = true;
          } else {
          ...
          nr_St_OnLine = false;
          ns_St_OnLine = Lab_V2__St_OnLine;
        ...
        case Lab_V2__St_LostLine:
          ...
          st_St_2_LineFollow_St_LostLine = Lab_V2__LostLine;
          nr_St_LostLine = false;
          ns_St_LostLine = Lab_V2__St_LostLine;
    ...
    case Lab_V2__St_2_ObstacleFollowing:
      ...
      st_St_2_ObstacleFollowing = Lab_V2__ObstacleFollowing;
      ...
      if (ir_front) {
        v_92 = true;
        v_91 = Lab_V2__St_2_LineFollow;
      } else {
        v_92 = false;
        v_91 = Lab_V2__St_2_ObstacleFollowing;
      };
      v_89 = !(ir_front);
      ...
      if (v_90) {
        ...
        ns_2_St_2_ObstacleFollowing = Lab_V2__St_2_WallFollowing;
      } else {
    ...
    case Lab_V2__St_2_WallFollowing:
      ...
      if (v_35) {
        ...
        ns_2_St_2_WallFollowing = Lab_V2__St_2_TurnRightEnd;
      } else {
        nr_2_St_2_WallFollowing = false;
        ns_2_St_2_WallFollowing = Lab_V2__St_2_WallFollowing;
      };
      ...
      switch (ck_4) {
        case Lab_V2__St_1_CheckState:
          ...
          if (v_49) {
            v_51 = true;
            v_50 = Lab_V2__St_1_MoveForward;
          } else {
            v_51 = pnr_1;
            v_50 = Lab_V2__St_1_CheckState;
          };
          v_48 = (left_front_too_far&&left_back_correct);
          if (v_48) {
            v_53 = true;
            v_52 = Lab_V2__St_1_LeftTurnSlow;
          } else {
            v_53 = v_51;
            v_52 = v_50;
          };
          ...
          if (v_47) {
            v_55 = true;
            v_54 = Lab_V2__St_1_RightTurnSlow;
          } else {
            v_55 = v_53;
            v_54 = v_52;
          };
          ...
          if (v_46) {
            v_57 = true;
            v_56 = Lab_V2__St_1_RightTurnSlow;
          } else {
            v_57 = v_55;
            v_56 = v_54;
          };
          ...
          if (v_45) {
            v_59 = true;
            v_58 = Lab_V2__St_1_LeftTurnSlow;
          } else {
            v_59 = v_57;
            v_58 = v_56;
          };
          ...
          if (v_40) {
            ...
            s_1_St_1_CheckState = Lab_V2__St_1_Turn90Right;
          } else {
      ...
      switch (ck_5) {
        case Lab_V2__St_1_CheckState:
          ...
          st_St_2_WallFollowing_St_1_CheckState = Lab_V2__Error;
          nr_1_St_1_CheckState = false;
          ns_1_St_1_CheckState = Lab_V2__St_1_CheckState;
        ...
        case Lab_V2__St_1_Turn90Right:
          ...
          st_St_2_WallFollowing_St_1_Turn90Right = Lab_V2__Turn90Right;
          ...
          if (finished_turn) {
            ...
            ns_1_St_1_Turn90Right = Lab_V2__St_1_CheckState;
          } else {
            nr_1_St_1_Turn90Right = false;
            ns_1_St_1_Turn90Right = Lab_V2__St_1_Turn90Right;
          };
        ...
        case Lab_V2__St_1_MoveAway:
          ...
          st_St_2_WallFollowing_St_1_MoveAway = Lab_V2__MoveAway;
          if (true) {
          ...
          if (true) {
            ns_1_St_1_MoveAway = Lab_V2__St_1_CheckState;
          } else {
            ns_1_St_1_MoveAway = Lab_V2__St_1_MoveAway;
          };
        ...
        case Lab_V2__St_1_MoveCloser:
          ...
          st_St_2_WallFollowing_St_1_MoveCloser = Lab_V2__MoveCloser;
          if (true) {
          ...
          if (true) {
            ns_1_St_1_MoveCloser = Lab_V2__St_1_CheckState;
          } else {
            ns_1_St_1_MoveCloser = Lab_V2__St_1_MoveCloser;
          };
        ...
        case Lab_V2__St_1_RightTurn:
          ...
          st_St_2_WallFollowing_St_1_RightTurn = Lab_V2__RightTurn;
          if (true) {
          ...
          if (true) {
            ns_1_St_1_RightTurn = Lab_V2__St_1_CheckState;
          } else {
            ns_1_St_1_RightTurn = Lab_V2__St_1_RightTurn;
          };
        ...
        case Lab_V2__St_1_LeftTurn:
          ...
          st_St_2_WallFollowing_St_1_LeftTurn = Lab_V2__LeftTurn;
          if (true) {
          ...
          if (true) {
            ns_1_St_1_LeftTurn = Lab_V2__St_1_CheckState;
          } else {
            ns_1_St_1_LeftTurn = Lab_V2__St_1_LeftTurn;
          };
        ...
        case Lab_V2__St_1_RightTurnSlow:
          ...
          st_St_2_WallFollowing_St_1_RightTurnSlow = Lab_V2__RightTurn;
          if (true) {
          ...
          if (true) {
            ns_1_St_1_RightTurnSlow = Lab_V2__St_1_CheckState;
          } else {
            ns_1_St_1_RightTurnSlow = Lab_V2__St_1_RightTurnSlow;
          };
        ...
        case Lab_V2__St_1_LeftTurnSlow:
          ...
          st_St_2_WallFollowing_St_1_LeftTurnSlow = Lab_V2__LeftTurn;
          if (true) {
          ...
          if (true) {
            ns_1_St_1_LeftTurnSlow = Lab_V2__St_1_CheckState;
          } else {
            ns_1_St_1_LeftTurnSlow = Lab_V2__St_1_LeftTurnSlow;
          };
        ...
        case Lab_V2__St_1_MoveForward:
          ...
          st_St_2_WallFollowing_St_1_MoveForward = Lab_V2__MoveForward;
          if (true) {
          ...
          if (true) {
            ns_1_St_1_MoveForward = Lab_V2__St_1_CheckState;
          } else {
            ns_1_St_1_MoveForward = Lab_V2__St_1_MoveForward;
          };
    ...
    case Lab_V2__St_2_TurnRightEnd:
      ...
      st_St_2_TurnRightEnd = Lab_V2__TurnRightEnd;
      nr_2_St_2_TurnRightEnd = false;
      ns_2_St_2_TurnRightEnd = Lab_V2__St_2_TurnRightEnd;
